				...
				<div class="row">					
					<div class="col-sm-12">
						<div class="shadow-wrapper">
							<h3 class="org-head">Organization <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenter"><span><i class="fa fa-plus-square"></i> </span> Add</button></h3>
