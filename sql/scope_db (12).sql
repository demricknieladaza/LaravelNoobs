...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 26, 2018 at 05:47 AM
...
--
ALTER TABLE `bid_meetings_tbl`
  MODIFY `bid_meet_tbl` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `organisation_awards_tbl`
  MODIFY `oa_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
