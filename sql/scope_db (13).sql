...
CREATE TABLE `bid_advise_tbl` (
  `bid_advise_id` int(11) NOT NULL,
...
CREATE TABLE `bid_deliverables_tbl` (
...
CREATE TABLE `bid_meetings_tbl` (
  `bid_meet_tbl` int(11) NOT NULL,
  `tender_id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
...
CREATE TABLE `employer_details_tbl` (
...
CREATE TABLE `organisation_accreditation_tbl` (
  `accre_id` int(11) NOT NULL,
...
CREATE TABLE `organisation_department_tbl` (
...
CREATE TABLE `successful_tender` (
  `succ_id` int(11) NOT NULL,
  `tender_id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(1, 1, 'Acoustic Engineer', 'Active', '2018-11-14 19:56:08', '2018-11-01 00:00:00', 1, 'TBC', NULL, NULL, '2018-11-08 09:42:50', '2018-11-14 19:56:08', NULL),
...
--
-- Indexes for table `bid_advise_tbl`
--
ALTER TABLE `bid_advise_tbl`
  ADD PRIMARY KEY (`bid_advise_id`);
...
--
-- Indexes for table `bid_deliverables_tbl`
--
ALTER TABLE `bid_deliverables_tbl`
...
--
-- Indexes for table `bid_meetings_tbl`
--
ALTER TABLE `bid_meetings_tbl`
  ADD PRIMARY KEY (`bid_meet_tbl`);
...
--
-- Indexes for table `employer_details_tbl`
--
ALTER TABLE `employer_details_tbl`
...
--
-- Indexes for table `organisation_accreditation_tbl`
--
ALTER TABLE `organisation_accreditation_tbl`
  ADD PRIMARY KEY (`accre_id`);
...
--
-- Indexes for table `organisation_department_tbl`
--
ALTER TABLE `organisation_department_tbl`
...
--
-- Indexes for table `successful_tender`
--
ALTER TABLE `successful_tender`
  ADD PRIMARY KEY (`succ_id`);
...
--
-- AUTO_INCREMENT for table `bid_advise_tbl`
--
ALTER TABLE `bid_advise_tbl`
  MODIFY `bid_advise_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT for table `bid_deliverables_tbl`
--
ALTER TABLE `bid_deliverables_tbl`
  MODIFY `deliv_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
-- AUTO_INCREMENT for table `bid_meetings_tbl`
--
ALTER TABLE `bid_meetings_tbl`
  MODIFY `bid_meet_tbl` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `employer_details_tbl`
--
ALTER TABLE `employer_details_tbl`
...
--
ALTER TABLE `individuals_accredation_tbl`
  MODIFY `accredatation_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `individuals_project_tbl`
  MODIFY `indp_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `individuals_tbl`
  MODIFY `ind_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
-- AUTO_INCREMENT for table `organisation_accreditation_tbl`
--
ALTER TABLE `organisation_accreditation_tbl`
  MODIFY `accre_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `organisation_awards_tbl`
--
ALTER TABLE `organisation_awards_tbl`
  MODIFY `oa_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `organisation_department_tbl`
--
ALTER TABLE `organisation_department_tbl`
...
--
ALTER TABLE `project_information_tbl`
  MODIFY `project_record_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- AUTO_INCREMENT for table `successful_tender`
--
ALTER TABLE `successful_tender`
  MODIFY `succ_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tender_appointment_tbl`
  MODIFY `tender_appointment_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `tender_queries_tbl`
  MODIFY `tender_query_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `tender_scope_advise_on_tbl`
--
ALTER TABLE `tender_scope_advise_on_tbl`
  MODIFY `advise_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `tender_scope_deliverables_tbl`
--
ALTER TABLE `tender_scope_deliverables_tbl`
  MODIFY `deliverables_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
